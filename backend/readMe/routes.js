    ...
    // DELETE http://localhost:5000/profile/:id => cancella un profilo attraverso l'ID di params e se employee anche il doc. corrispondente (solo Admin_DA FARE)
...
// GET http://localhost:5000/employee => mostra tutti i dipendenti dell'azienda (?role=addetta X ricerca)
    ...
    // PUT http://localhost:5000/employee/:id => modifica il doc. employee nella collection  (PERMESSI - FERIE DA FARE)
